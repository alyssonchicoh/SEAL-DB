...
public class ClosableTabbedPane extends JTabbedPane{
	...
	private static final long serialVersionUID = 1L;
		...
		private CloseTabbeListener closeTabbeListener;
                ...
                public void mouseReleased(MouseEvent me) {
                        if(closeUnderMouse(me.getX(), me.getY())){
                                ...
                                if (isToCloseTab && selectedTab > -1){
                                	...
                                	if(closeTabbeListener!=null)closeTabbeListener.close(tabbedPane.getTitleAt(selectedTab));
		...
		public CloseTabbeListener getCloseTabbeListener() {
			return closeTabbeListener;
		}

		public void setCloseTabbeListener(CloseTabbeListener closeTabbeListener) {
			this.closeTabbeListener = closeTabbeListener;
		}
